...
\usepackage{ulem}
\usepackage{wrapfig}
\usepackage[style=reading, entrykey=false, backend=bibtex, dateabbrev=false, urldate=long]{biblatex}
...
\section{Implementierung der hergeleiteten Formeln}\label{sec:sim} %TODO besserer Titel
...
Weiterhin wird für die Berechnungen eine Python-Bibliothek mit gleichem Funktionsumfang aber ohne die dazugehörige Benutzeroberfläche entwickelt. %TODO !!! Python abgabefertig? Muss noch etwas hinzugefügt/geändert werden?
...
Wie in der nebenstehenden Abbildung \ref{fig:Wegunterschied} zu erkennen ist, sind die zurückgelegten Strecken, und damit die benötigte Zeit der einzelnen Strahlen, besonders bei kleineren Streuwinkeln gering. %TODO ref richtig machen
...
\subsection{Verwendung des Programms} %TODO lieber in Sätzen?
