...
\usepackage{wrapfig}
\usepackage{csquotes}
\usepackage[style=science, entrykey=false, backend=biber, dateabbrev=false, urldate=long]{biblatex}
...
All diese Verletzungen sind häufig anzutreffen und werden zumeist durch das Röntgenverfahren eindeutig diagnostiziert. %TODO anderes Wort als diagnostiziert?
...
Anschließend wird aus dieser Liste an Differenzen die Stelle gesucht, an der der Quotient aus zwei aufeinanderfolgenden Zeitdifferenzen am größten ist und der größere Wert der Zeitdifferenzen als sogenannter Zeitbereich definiert. %TODO Wortwiederholung wird
...
Die Gruppe wird dann ausgewertet, indem eine durchschnittliche Intensität der Treffer sowie eine Durch\-schnitts\-zeit errechnet wird. %TODO durchschnittszeit wird falsch getrennt
